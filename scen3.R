...
# =============================================================================	
	...
	scen3_sf <- st_as_sf(scen3_tmp) %>%	
		mutate(ras_val = 1)
	scen3_out <- s3
	save(scen3_sf, file = "C:/Users/saraw/Desktop/scenario_outputs/scen3/scen3_sf.Rdata")
	save(scen3_out, file = "C:/Users/saraw/Desktop/scenario_outputs/scen3/scen3_out.Rdata")
...
# =============================================================================	
	...
	save(scen3_blm_sf, file = "C:/Users/saraw/Desktop/scenario_outputs/scen3/scen3_blm_sf.Rdata")
	save(scen3_blm_out, file = "C:/Users/saraw/Desktop/scenario_outputs/scen3/scen3_blm_out.Rdata")
