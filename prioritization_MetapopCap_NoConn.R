...
load("no_conn_prior_patches.Rdata")
no_conn_prior_r <- raster("no_conn_prior_r.tif")



# =============================================================================
#  Load base layer input data for prioritization with NO connectivity layers
# =============================================================================
...
# =============================================================================
	...
	disp_dist_max <- 233344 ## Neofelis nebulosa
	disp_dist_med <- 27148 ## Neofelis nebulosa
...
# =============================================================================
	...
	save(out_locs_no_conn_prior, file = "out_locs_no_conn_prior.Rdata")		
...
# =============================================================================
	...
	hab_corr_fac <- c((low_resist/1), # correction for non-forest
		(low_resist/0.0001), # correction for PA/prioritized area
		(low_resist/0.1)) # correction for logged forest
	# Patch types: 
	# 0 = Non-forest
