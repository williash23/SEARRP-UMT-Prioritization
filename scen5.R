...
# =============================================================================
	...
	p_vert2 <- problem(x = pu_in, features = vert_feat_in_single, cost_column = "area_h") %>%
		add_max_features_objective(454000) %>%
...
# =============================================================================	
	...
	p3 <- problem(x = pu_in, features = all_feat_in, cost_column = "area_h") %>%
		add_max_utility_objective(454000) %>%
...
# =============================================================================	
	...
	scen5_sf <- st_as_sf(scen5_tmp) %>%	
		mutate(ras_val = 1)
	scen5_out <- s3
	save(scen5_sf, file = "C:/Users/saraw/Desktop/scenario_outputs/scen5/scen5_sf.Rdata")
	save(scen5_out, file = "C:/Users/saraw/Desktop/scenario_outputs/scen5/scen5_out.Rdata")
...
# =============================================================================	
	...
	save(scen5_blm_sf, file = "C:/Users/saraw/Desktop/scenario_outputs/scen5/scen5_blm_sf.Rdata")
	save(scen5_blm_out, file = "C:/Users/saraw/Desktop/scenario_outputs/scen5/scen5_blm_out.Rdata")
