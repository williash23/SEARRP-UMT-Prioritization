...
# =============================================================================
		...
		# ----------------------
		#  Vertebrates
		chunks <- seq(1, 10, by = 1)
	
		adj_vert_rep_weight <- vert_rep_weight_w_pa_range
		...
		writeRaster(prior_vert_feat_r, file = "chunks/prior_vert_feat_r_w_pa_range.grd")
		...
		writeRaster(prior_fly_feat_r, file = "chunks/prior_fly_feat_r_w_pa_range.grd")
		...
		writeRaster(prior_plant_feat_r, file = "chunks/prior_plant_feat_r_w_pa_range.grd")
		...
		writeRaster(prior_form_feat_r, file = "chunks/prior_form_feat_r_w_pa_range.grd")
