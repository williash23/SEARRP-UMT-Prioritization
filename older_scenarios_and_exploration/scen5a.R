...
# =============================================================================	
	...
	all_feat_in <- stack(prior_vert_feat_r, prior_fly_feat_r, prior_plant_feat_r, 
		elev_conn_feat_r, corr_feat_r, acd_feat_r)
...
# =============================================================================	
	...
	# ----------------------
	#  Save output.
	scen5a_tmp <- as(s3_sf, "Spatial")
	scen5a_sf <- st_as_sf(scen5a_tmp) %>%	
		mutate(ras_val = 1)
	scen5a_out <- s3
	save(scen5a_sf, file = "scenario_outputs/scen5/scen5a_sf.Rdata")
	save(scen5a_out, file = "scenario_outputs/scen5/scen5a_out.Rdata")
